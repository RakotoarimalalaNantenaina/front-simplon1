                    ...
                    this.state.profil.filter(us=>us.valid==true).map(user => (
                        ...
                        <div class="item col-xs-3 col-lg-3" id="carte">
                            ...
                            <div className="card card-cascade narrower card-ecommerce">
                                <img width="auto" id="imageproduit" height="230px" src={'https://boiling-dawn-95363.herokuapp.com/atelier/' + user.photo_produit} alt={user.photo_produit} />
                                                    ...
                                                    customUI: ({ onClose }) => {
                                                        return (
                                                            <div id="div1">
                                                                ...
                                                                <button
                                                                    onClick={() => {
                                                                        axios.post("https://boiling-dawn-95363.herokuapp.com/particulier/" + user._id, {
                                                                            nom: this.state.nom,
                                                                            prenom: this.state.prenom,
                                                                            numtel: this.state.numtel,
                                                                            email: this.state.email
                                                                        }).then(res => {
                                                                            axios.get("https://boiling-dawn-95363.herokuapp.com/atelier").then(res => {
